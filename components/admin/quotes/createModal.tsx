        ...
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 px-4">
            <div className="bg-accent border border-primary/20 p-6 rounded-lg w-full container mx-auto">
                ...
                <div className="mt-2 md:mt-4">
                    <label className="block text-xs md:text-sm font-medium text-primary mb-1">
                        Materials Checklist
                    </label>
                    ...
                    <div className="flex gap-2 mb-3">
                        ...
                        <button
                            onClick={addMaterial}
                            className="px-4 py-2 bg-primary text-white rounded hover:scale-105 transition-transform cursor-pointer"
                        >
                            Add
                        </button>
                    </div>
                    ...
                    <ul
                        className={`space-y-2 overflow-y-scroll max-h-40 ${newQuoteForm.materials.length > 3 ? "pr-4" : ""}`}
                    >
                        {newQuoteForm.materials.map((material) => (
