...
export const Header = () => {
    ...
    return (
        <header className="bg-accent text-white fixed w-full z-50">
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden bg-accent border-t border-primary/20 overflow-hidden transition-all duration-300 ease-in-out ${
            ...
            >
                <nav className="flex flex-col px-6 py-4 space-y-4">
                    ...
                    <Link href="tel:07545410930" className="pt-4 border-t border-primary/20 flex items-center gap-2">
                        <FaPhone className="text-primary" />
                        <span className="font-semibold">07545 410930</span>
                    </Link>
                    {session ? (
